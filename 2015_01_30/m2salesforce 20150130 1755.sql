...
CREATE TABLE `inf_series` (
  ...
  `series_name_en` varchar(255) NOT NULL,
  `series_name_th` varchar(255) NOT NULL,
  `is_active` enum('n','y') DEFAULT 'y',
  `created_dt` datetime NOT NULL,
  `created_by` varchar(50) NOT NULL,
  `modified_dt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `inf_sub_series` (
  ...
  `sub_series_name_en` varchar(255) NOT NULL,
  `sub_series_name_th` varchar(255) NOT NULL,
  `is_active` enum('n','y') DEFAULT 'y',
  `created_dt` datetime NOT NULL,
  `created_by` varchar(50) NOT NULL,
  `modified_dt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `type_trx_status` (`status_id`,`status_name_en`,`created_dt`) VALUES 
 ...
 (2,'verified','0000-00-00 00:00:00'),
 (3,'process','0000-00-00 00:00:00'),
 (4,'done','0000-00-00 00:00:00');
