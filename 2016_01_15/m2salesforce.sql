...
CREATE TABLE `acl_account_member` (
  ...
  `is_account_active_flag` enum('n','w','y') NOT NULL DEFAULT 'w' COMMENT 'activate_status',
...
-- ----------------------------
INSERT INTO acl_account_member VALUES ('2cf2d6ca-5207-49e9-91ec-94b82a705122', '', '9999999999999', '9999999999', null, null, 'firstname', 'lastname', 'SCB', '1234566423', 'lalit@mobizign.com', 'n', 'pinencode', '0', 'w', 'n', '1', '2015-02-23 22:25:10', 'username', '2015-12-02 12:40:27', 'username', '');
INSERT INTO acl_account_member VALUES ('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9', null, '1', '1', null, null, '1', '1', 'BBL', '1', '1', 'n', '1', '0', 'w', 'n', '1', '2015-10-21 19:20:06', '', '2015-12-02 12:40:31', '', null);
...
-- Records of inf_item
-- ----------------------------
INSERT INTO inf_item VALUES ('1c84c034-b9f6-11e5-8f75-90e6ba0e50c6', '1', '1', 'ABCODE1', 'MAZDA', 'MAZDA2', '1.3 Standard', 'Mazda2 1.3 Standard', 'รายละเอียดรถ mazda2 รุ่น 1.3 Standard', 'y', '1', '2016-01-13 20:03:59', '2016-01-13 20:15:10');
INSERT INTO inf_item VALUES ('97a25ac8-b9f7-11e5-8f75-90e6ba0e50c6', '1', '1', 'ABCODE2', 'MAZDA', 'MAZDA2', '1.3 High', 'Mazda2 1.3 High', 'รายละเอียดรถ mazda2 รุ่น 1.3 High', 'y', '1', '2016-01-13 20:14:35', '2016-01-13 20:14:35');
INSERT INTO inf_item VALUES ('c9ee5a18-b9f7-11e5-8f75-90e6ba0e50c6', '1', '1', 'ABCODE3', 'MAZDA', 'MAZDA2', '1.3 High Plus', 'Mazda2 1.3 High Plus', 'รายละเอียดรถ mazda2 รุ่น 1.3 High Plus', 'y', '1', '2016-01-13 20:16:00', '2016-01-13 20:16:00');
INSERT INTO inf_item VALUES ('e833b7d4-b9f7-11e5-8f75-90e6ba0e50c6', '1', '1', 'ABCODE4', 'MAZDA', 'MAZDA2', 'XD', 'Mazda2 XD', 'รายละเอียดรถ mazda2 รุ่น XD', 'y', '1', '2016-01-13 20:16:50', '2016-01-13 20:16:50');
INSERT INTO inf_item VALUES ('f116dc00-b9f7-11e5-8f75-90e6ba0e50c6', '1', '1', 'ABCODE5', 'MAZDA', 'MAZDA2', 'XD High', 'Mazda2 XD High', 'รายละเอียดรถ mazda2 รุ่น XD High', 'y', '1', '2016-01-13 20:17:05', '2016-01-13 20:17:05');
INSERT INTO inf_item VALUES ('f72f424e-b9f7-11e5-8f75-90e6ba0e50c6', '1', '1', 'ABCODE6', 'MAZDA', 'MAZDA2', 'XD High Plus', 'Mazda2 XD High Plus', 'รายละเอียดรถ mazda2 รุ่น XD High Plus', 'y', '1', '2016-01-13 20:17:15', '2016-01-13 20:17:15');
...
-- ----------------------------
INSERT INTO inf_item_category VALUES ('1', 'ยานยนต์', 'Motor', 'สินค้า กลุ่ม ยานยนต์ ประเภทต่างๆ', 'y', '2016-01-13 19:28:18');
INSERT INTO inf_item_category VALUES ('2', 'ประกันภัย', 'Insurance', 'ประกันภัย ประเภทต่างๆ', 'y', '2016-01-13 19:28:25');
INSERT INTO inf_item_category VALUES ('3', 'อสังหาริมทรัพย์', 'Real Estate', 'อสังหาริมทรัพย์ ต่างๆ', 'y', '2016-01-13 19:28:38');
INSERT INTO inf_item_category VALUES ('99', 'อื่นๆ', 'Other', 'อื่นๆ', 'y', '2016-01-13 19:28:29');
...
-- ----------------------------
INSERT INTO inf_item_checklist_group VALUES ('1', 'Motor-Mazda2-Checklist', 'รายการสิ่งที่ต้องการในการซื้อรถ ', '2016-01-15 12:36:30');
...
CREATE TABLE `trx_customer_pool` (
  ...
  `modified_dt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`member_account_id`,`customer_account_id`),
...
CREATE TABLE `trx_order_detail` (
  `trx_order_detail_id` varchar(36) NOT NULL,
  `trx_order_id` varchar(36) NOT NULL,
  `item_id` varchar(36) NOT NULL,
  `item_code` varchar(100) NOT NULL,
  `item_brand` varchar(100) NOT NULL,
  `item_series` varchar(100) NOT NULL,
  `item_sub_series` varchar(100) NOT NULL,
  `item_name` varchar(100) NOT NULL,
  `modified_dt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`trx_order_detail_id`),
  KEY `trxOrderId_refto_trxOrderMstr` (`trx_order_id`),
  CONSTRAINT `trxOrderId_refto_trxOrderMstr` FOREIGN KEY (`trx_order_id`) REFERENCES `trx_order_master` (`trx_order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `trx_order_detail_checklist`
-- ----------------------------
DROP TABLE IF EXISTS `trx_order_detail_checklist`;
CREATE TABLE `trx_order_detail_checklist` (
  `trx_order_detail_checklist_id` varchar(36) NOT NULL,
  `trx_order_detail_id` varchar(36) NOT NULL,
  `checklist_name` varchar(50) NOT NULL,
  `checklist_type` enum('text','file','multi_choice','single_choice') NOT NULL,
  `checklist_value_th` varchar(100) DEFAULT NULL,
  `checklist_value_en` varchar(100) NOT NULL,
  `modified_dt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`trx_order_detail_checklist_id`),
  KEY `trxOrderDetId_refto_trxOrderDetail` (`trx_order_detail_id`),
  CONSTRAINT `trxOrderDetId_refto_trxOrderDetail` FOREIGN KEY (`trx_order_detail_id`) REFERENCES `trx_order_detail` (`trx_order_detail_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of trx_order_detail_checklist
-- ----------------------------

-- ----------------------------
-- Table structure for `trx_order_master`
-- ----------------------------
DROP TABLE IF EXISTS `trx_order_master`;
CREATE TABLE `trx_order_master` (
  `trx_order_id` varchar(36) NOT NULL,
  `member_account_id` varchar(36) NOT NULL,
  `customer_account_id` varchar(36) NOT NULL,
...
CREATE TABLE `trx_sms` (
  ...
  KEY `trxOrdId_refto_irxOrderMstr` (`trx_order_id`),
  CONSTRAINT `trxOrdId_refto_irxOrderMstr` FOREIGN KEY (`trx_order_id`) REFERENCES `trx_order_master` (`trx_order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO type_bank VALUES ('BAAC', 'ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร', 'ธ.เพื่อการเกษตรและสหกรณ์การเกษตร', 'BAAC', 'n', '2015-10-21 20:43:10');
INSERT INTO type_bank VALUES ('BAY', 'Bank of Ayudhya Public Company Limited', 'ธ.กรุงศรีอยุธยา จำกัด (มหาชน)', 'AYUD', 'y', '2015-10-21 20:43:12');
INSERT INTO type_bank VALUES ('BBL', 'Bangkok Bank Public Company Limited', 'ธ.กรุงเทพ จำกัด (มหาชน)', 'BKKB', 'y', '2015-10-21 20:43:15');
INSERT INTO type_bank VALUES ('CIMBT', 'CIMB Thai Bank', 'ธ.ซีไอเอ็มบีไทย', 'UBOB', 'y', '2015-10-21 20:43:16');
INSERT INTO type_bank VALUES ('GSB', 'Government Saving Bank', 'ธ.ออมสิน', 'GSB', 'n', '2015-10-21 20:43:20');
INSERT INTO type_bank VALUES ('KBANK', 'Kasikorn Bank Public Company Limited', 'ธ.กสิกรไทย จำกัด (มหาชน)', 'KASI', 'y', '2015-10-21 20:43:23');
INSERT INTO type_bank VALUES ('KTB', 'Krung Thai Bank Public Company Limited', 'ธ.กรุงไทย จำกัด (มหาชน)', 'KRTH', 'y', '2015-10-21 20:43:25');
INSERT INTO type_bank VALUES ('SCB', 'Siam Commercial Bank Public Company Limited', 'ธ.ไทยพาณิชย์ จำกัด (มหาชน)', 'SICO', 'y', '2015-10-21 20:43:31');
INSERT INTO type_bank VALUES ('TCAP', 'Thanachart Bank Public Company Limited', 'ธ.ธนชาต จำกัด (มหาชน)', 'THBK', 'y', '2015-10-21 20:43:35');
INSERT INTO type_bank VALUES ('TMB', 'TMB Bank Public Company Limited', 'ธ.ทหารไทย จำกัด (มหาชน)', 'TMBK', 'y', '2015-10-21 20:43:39');
